...
class BallManage:
    ...
    def eat(sp1, sp2):
        ...
        if sp1.rect.width * sp1.rect.height > sp2.rect.width * sp2.rect.height:
        ...
        elif sp1.rect.width * sp1.rect.height < sp2.rect.width * sp2.rect.height:
            # other.alive = False
            sp1.kill()
            print("sp1被吃")
            ...
            # sp1.rect.width += sp2.rect.width
            # sp1.rect.height += sp2.rect.height
            cur_center = sp2.rect.center
            sp2.image = pygame.Surface((sp1.rect.width + sp2.rect.width, sp1.rect.height + sp2.rect.height))
            sp2.rect = sp2.image.get_rect()
            sp2.rect.center = cur_center
