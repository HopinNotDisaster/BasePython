# # 1.现有一个字典中所有的值都是数字，找到数字最大键 {“a”: 10, “b”: 20, “c”: 5} 返回b
# import sys
# dic = {
#     "a": 10, "b": 20, "c": 5
# }
...
# # 2.使用字典统计字符串中每个字符出现的次数 “hello wolrd”
# # 返回{“h”:1, “e”:1, ”l”:3, “o”:2, “w”: 1, “r”:1, “d”:1, “ ”:1}
# # 字典中的in是看键是都在dic中，看不了值
#
# dic = {
#
# }
...
# # 3.将一个字典转换为二维列表，[(key1,value1), (key2,value2), (key3,value3)]
#
# dic = {
#     "key1": "value1",
#     "key2": "value2",
...
#             print(di["ename"])
#             break
# B.输入角色类型 返回该类型角色总共有几个
# count =0
# type_ = int(input("输入："))
# for di in l0:
#
#     if di["hero_type"] == type_:
#         count +=1
#         print(di["ename"],di["cname"],count)
# # C.输入皮肤个数，返回拥有当前个数皮肤的英雄名字
#
# n = int(input("输入："))
# for di in l0:
#     if di["hero_type"] == n:
...
#     if "skin_name" in di:
#
#         count += di["skin_name"].count("|")
#         count += 1
#         print(di["skin_name"],di["ename"])
# print(count)
...
while 1:
    ...
    if n == 1:
        tem_na = input("输入名字：")
        tem_ag = int(input("输入年龄："))
        tem_se = input("输入性别：")
        students.append({"name": tem_na, "age": tem_ag, "sex": tem_se})
    if n == 2:
        print(students)
    if n == 3:
        sum_ag = 0
...
# C:\Users\QK\AppData\Roaming\XMind\Electron v3\vana\workbooks\106b13e453283da7b9020a7456\Thumbnails